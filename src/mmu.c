...
struct table_descriptor_stage1 L1table[512] __attribute__((aligned(4096))); //direcory pages


struct page_descriptor_stage1 L2table[512] __attribute__((aligned(4096))); //pages under each directory
